...
<head>
    ...
    <![endif]-->
    <link rel="shortcut icon" href="../../../resources/images/home/ico/favicon.ico">
    <link rel="apple-touch-icon-precomposed" sizes="144x144"
          href="../../../resources/images/home/ico/apple-touch-icon-144-precomposed.png">
    <link rel="apple-touch-icon-precomposed" sizes="114x114"
          href="../../../resources/images/home/ico/apple-touch-icon-114-precomposed.png">
    <link rel="apple-touch-icon-precomposed" sizes="72x72"
          href="../../../resources/images/home/ico/apple-touch-icon-72-precomposed.png">
    <link rel="apple-touch-icon-precomposed" href="../../../resources/images/home/ico/apple-touch-icon-57-precomposed.png">
</head>
<body>
            ...
            <div class="row">
                <div class="col-sm-4">
                    <div class="logo pull-left">
                        <a href="../../../webapp/WEB-INF/views/index.jsp"><img src="../../../resources/images/home/logo.png" alt="" /></a>
                    </div>
                ...
                <div class="col-sm-8">
                    <div class="shop-menu pull-right">
                        <ul class="nav navbar-nav">
                            ...
                            <li><a href=""><!--inserte jsp de la vista del carrito--><i class="fa fa-shopping-cart"></i> Cart</a></li>
                            <li><a href=""><!--inserte jsp de la vista de ayuda--><i class="fa fa-question"></i> Help</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="col-sm-9">
                    ...
                    <div class="mainmenu pull-left">
                        <ul class="nav navbar-nav collapse navbar-collapse">
                            ...
                            <li><a href=""><!--inserte jsp de vista de contacto -->Contact</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-sm-3">
...
<section id="slider" xmlns:jsp="http://java.sun.com/JSP/Page"><!--slider-->
    <div class="container">
        <div class="row">
            <div class="col-sm-12">
                <div class="breadcrumbs">
                    <ol class="breadcrumb">
                        ...
                        <li class="active"><a id="miBoton" href="../../../webapp/WEB-INF/views/onlinestore/configureHomePage.jsp">Edit Home Page</a></li>
                ...
                <div id="slider-carousel" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        ...
                        <div class="item">
                            <div class="col-sm-6">
                                <h1><span>E</span>-SHOPPER</h1>
                                <h2>The Best Ecommerce</h2>
                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor
                                    incididunt ut labore et dolore magna aliqua. </p>
                                <button type="button" class="btn btn-default get"
                                        href='<%= session.getAttribute("sld3") %>'>Get it now
                                </button>
                            </div>
                            <div class="col-sm-6">
            ...
            <div class="col-sm-3">
                <div class="left-sidebar">
                    ...
                    <div class="panel-group category-products" id="accordian"><!--category-products-->
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h4 class="panel-title"><a href="<%= session.getAttribute("catDir2") %>">Mens</a></h4>
                            </div>
                        </div>
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h4 class="panel-title"><a href="<%= session.getAttribute("catDir3") %>">Womens</a></h4>
                            </div>
                        </div>
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h4 class="panel-title"><a href="<%= session.getAttribute("catDir4") %>">Kids</a></h4>
                            </div>
                        </div>
                        <div class="panel panel-default">
                            <div class="panel-heading">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h4 class="panel-title"><a href="<%= session.getAttribute("catDir9") %>">Bags</a></h4>
                            </div>
                        </div>
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h4 class="panel-title"><a href="<%= session.getAttribute("catDir10") %>">Shoes</a></h4>
                            </div>
                        </div>
                ...
                <div class="features_items"><!--features_items-->
                        ...
                        <div class="product-image-wrapper">
                            <div class="single-products">
                                <div class="productinfo text-center">
                                    <img src="../resources/images/home/<%=session.getAttribute("featImg1")%>" alt=""/>
                                    <h2>$56</h2>
                    ...
                    <div class="col-sm-4">
                        <div class="product-image-wrapper">
                            <div class="single-products">
                                <div class="productinfo text-center">
                                    <img src="../resources/images/home/<%=session.getAttribute("featImg2")%>" alt=""/>
                                    <h2>$56</h2>
                                    <p>Easy Polo Black Edition</p>
                                    <a href="#" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add
                                        to cart</a>
                    ...
                    <div class="col-sm-4">
                        <div class="product-image-wrapper">
                            <div class="single-products">
                                <div class="productinfo text-center">
                                    <img src="../resources/images/home/<%=session.getAttribute("featImg3")%>" alt=""/>
                                    <h2>$56</h2>
                                    <p>Easy Polo Black Edition</p>
                                    <a href="#" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add
                                        to cart</a>
                    ...
                    <div class="col-sm-4">
                        <div class="product-image-wrapper">
                            <div class="single-products">
                                <div class="productinfo text-center">
                                    <img src="../resources/images/home/<%=session.getAttribute("featImg4")%>" alt=""/>
                                    <h2>$56</h2>
                                    <p>Easy Polo Black Edition</p>
                                    <a href="#" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add
                                        to cart</a>
                    ...
                    <div class="col-sm-4">
                        <div class="product-image-wrapper">
                            <div class="single-products">
                                <div class="productinfo text-center">
                                    <img src="../resources/images/home/<%=session.getAttribute("featImg5")%>" alt=""/>
                                    <h2>$56</h2>
                                    <p>Easy Polo Black Edition</p>
                                    <a href="#" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add
                                        to cart</a>
                    ...
                    <div class="col-sm-4">
                        <div class="product-image-wrapper">
                            <div class="single-products">
                                <div class="productinfo text-center">
                                    <img src="../resources/images/home/<%=session.getAttribute("featImg6")%>" alt=""/>
                                    <h2>$56</h2>
                                    <p>Easy Polo Black Edition</p>
                                    <a href="#" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add
                                        to cart</a>
